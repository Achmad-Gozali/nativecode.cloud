...
const paketSEO = [
  {
    nama: 'SEO Bergaransi', sub: 'Untuk Website dari nativecode.id', harga: '600K', satuan: '/Bulan',
    ...
    detail: {
      deskripsi: 'SEO nativecode.id membantu kata kunci pencarian bisnis Anda tampil di Google dan terbukti efektif mendukung kesuksesan bisnis klien.',
      poin: [
  ...
  {
    nama: 'SEO Reguler', sub: 'Untuk Website di Luar nativecode.id', harga: '950K', satuan: '/Bulan',
    fitur: ['SEO website bahasa Indonesia Rp950.000/bulan', 'SEO website bahasa Inggris Rp2.200.000/bulan'],
    detail: {
      deskripsi: 'Layanan optimasi SEO untuk website yang tidak dibangun oleh nativecode.id, dengan kualitas dan proses yang sama seperti paket SEO Bergaransi.',
      poin: [
        'Optimasi untuk 5 kata kunci sesuai target pasar Anda, ditambah kata kunci bonus.',
...
const faq = [
  ...
  { q: 'Apa bedanya paket SEO Bergaransi dengan SEO Reguler?', a: 'Paket SEO Bergaransi khusus untuk website yang dibuat melalui nativecode.id, dengan harga lebih terjangkau karena kami sudah familiar dengan struktur websitenya. Paket SEO Reguler berlaku untuk website luar atau website yang tidak dibuat oleh nativecode.id. Keduanya mendapatkan layanan optimasi yang sama berkualitasnya.' },
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
              ...
              <div className="fade-right hidden lg:flex items-center justify-center">
                <img src="/images/layanan-seo/ilustrasi-ranking-seo.png" alt="SEO Bergaransi nativecode.id" className="w-full max-w-sm lg:max-w-lg object-contain" />
              </div>
            </div>
          </div>
